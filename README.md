...
## What it does
Search any aircraft callsign (e.g. `ANZ1`, `UAL888`) to see its live latitude/longitude, altitude, ground speed, and flight status, sourced directly from real-time ADS-B transponder data.
